...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/tor2r/laravel-brreg-api/fix-php-code-style-issues.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/tor2r/laravel-brreg-api/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-brreg-api.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-brreg-api)
...
```bash
php artisan vendor:publish --tag="laravel-brreg-api-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-brreg-api-views"
```

## Usage

```php
$brregAPi = new Tor2r\BrregAPi();
echo $brregAPi->echoPhrase('Hello, Tor2r!');
```
